    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-600 to-purple-800 flex items-center justify-center">
      <div className="bg-white rounded-lg shadow-xl p-8 w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold">Join HangoutSession</h1>
          <p className="text-gray-600 mt-2">Just be yourself — Get Booked to hangout face to face</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <Button type="submit" className="w-full bg-purple-600 hover:bg-purple-700" disabled={signup.isPending}>
        ...
        <div className="mt-6 text-center">
          <p className="text-gray-600">
            ...
            <Link href="/signin">
              <span className="text-purple-600 hover:underline cursor-pointer">Sign In</span>
            </Link>
          </p>
        </div>
      </div>
